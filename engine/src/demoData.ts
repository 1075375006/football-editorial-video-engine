...
export const demoSceneDocument: SceneDocument = {
  ...
  scenes: [
    ...
    {id: 'mechanism', pattern: 'TACT-02', startFrame: 1020, durationInFrames: 240, narration: 'When Saka moves inside, the fullback can overlap outside him.', information: {headline: 'WHEN 7 MOVES INSIDE'}, motionPreset: ['M07 tactical-build', 'M08 line-draw']},
    {id: 'space', pattern: 'TACT-03', startFrame: 1260, durationInFrames: 150, narration: 'That rotation exposes the half-space behind the first screen.', information: {headline: 'THE SPACE IS HERE'}, motionPreset: ['M05 focus-push', 'M08 line-draw']},
